                ...
                child: Column(children: [
                  Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
                    ...
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Row(children: [Flexible(child: Text(user.name, style: AppTypography.soraHeading2())), if (user.isVerified) ...[const SizedBox(width: 6), const Icon(Icons.verified_rounded, color: AppColors.cyanDeep, size: 18)], if (user.isPremium) ...[const SizedBox(width: 6), const PremiumBadge(isSmall: true)]]),
